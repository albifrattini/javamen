...
public class Table {
	...
	private ArrayList<TowerRoom> towerRooms = new ArrayList<TowerRoom>(TOWER_ROOM_SPACES);
	private ArrayList<MarketRoom> market = new ArrayList<MarketRoom>(MARKET_ROOM_SPACES);
	private ArrayList<HarvestingRoom> harvestingRooms = new ArrayList<HarvestingRoom>(PH_SPACES);
	private ArrayList<ProductionRoom> productionRooms = new ArrayList<ProductionRoom>(PH_SPACES);
